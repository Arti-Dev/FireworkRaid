...
public class CustomQueueItems {
    public static NamespacedKey damageKey = new NamespacedKey(FireworkRaid.getInstance(), "queue_item_damage");
    public static NamespacedKey rangeKey = new NamespacedKey(FireworkRaid.getInstance(), "queue_item_range");
    public static NamespacedKey quickChargeKey = new NamespacedKey(FireworkRaid.getInstance(), "queue_item_quickcharge");
    public static NamespacedKey multiShotKey = new NamespacedKey(FireworkRaid.getInstance(), "queue_item_multishot");
